    ...
    <div className="min-h-screen bg-cream">
        ...
        <div className="container mx-auto px-4 py-6">
          <nav className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              ...
              <Link
                href="/signup"
                className="px-4 py-2 bg-white text-primary-dark rounded-lg hover:bg-cream transition-colors font-medium"
              >
                新規登録
              </Link>
            </div>
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            href="/signup"
            className="inline-block px-8 py-4 bg-primary text-white text-lg font-medium rounded-lg hover:bg-primary-dark transition-colors shadow-lg"
          >
            無料で始める
          </Link>
        </div>
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/20">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">文法学習</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/20">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">発音練習</h3>
            <p className="text-gray-600">
      ...
      <footer className="container mx-auto px-4 py-8 mt-20 border-t border-primary/20">
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-4">
          <Link href="/terms" className="text-gray-500 hover:text-primary-dark">
            利用規約
          </Link>
          <span className="hidden md:inline text-gray-300">|</span>
          <Link href="/privacy" className="text-gray-500 hover:text-primary-dark">
            プライバシーポリシー
          </Link>
        </div>
